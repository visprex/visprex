...
const Parser: React.FC<ParserProps> = ({ onDataParsed }) => {
  ...
  return (
    <div
      className={`drop-zone ${isDragging ? 'drag-over' : ''} h-40 bg-gray-200 className="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"`}
